    ...
    window.DataChannel = function(channel, extras) {
        ...
        function prepareInit(callback) {
            ...
            if (!self.openSignalingChannel) {
                ...
                self.openSignalingChannel = function(config) {
                    ...
                    var socket = new window.Firebase('https://sweltering-heat-3339.firebaseio.com/' + channel);
        ...
        if (self.automatic) {
            if (window.Firebase) {
                ...
                new window.Firebase('https://sweltering-heat-3339.firebaseio.com/chat' + self.channel).once('value', function(data) {
