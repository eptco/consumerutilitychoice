...
(function() {
    ...
    window.RTCMultiConnection = function(channel) {
        ...
        function joinSession(session, joinAs) {
            ...
            if (!session || !session.userid || !session.sessionid) {
                console.error('missing arguments', arguments);
    ...
    function setDefaults(connection) {
        ...
        connection.resources = {
            ...
            firebase: './js/plugins/chat/firebase.js',
            firebaseio: 'https://sweltering-heat-3339.firebaseio.com/',
            ...
            FileBufferReader: './js/plugins/chat/FileBufferReader.js'
        };
