    ...
    include ("./insurehc.php");
                                                        ...
                                                        ?>
                                                                   ...
                                                                   // $assurantNumbers[] = "AA025144000402";
                                                                    ...
                                                                    $writingnumber = $assurantNumbers[mt_rand(0, count($assurantNumbers) - 1)];
                                                                    //echo $writingnumber;
...
if(!empty($result['history'])){
    ...
    echo "</ul>";
        ...
        <div class="modal inmodal" id="assurantSubmit" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg" style="width: 80%">
                <div class="modal-content animated bounceInRight">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                        <i class="fa fa-briefcase modal-icon"></i>
                        <h4 class="modal-title">ASSURANT QUOTE AND SUBMIT </h4>
                    </div>
                    <div class="modal-body" id="assurantSubmitList">
                        Getting Quote
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-white" data-dismiss="modal">Close</button>
        ...
        <script>
            ...
            function quoteMajor() {
              ...
              function submitAssurant() {
                ...
                $("#assurantSubmit").modal('show');

                $.ajax({
                    url: "<?php echo $settings['base_uri'];?>api/assurant/?test=u",
                    type: 'POST',
                    data: $("#leadform").serialize(),
                    success: function(result) {
