    ...
    <form id="personalInfoForm" data-parsley-validate>
        ...
        <div class="col-md-<?= (!empty($result['active_script'])) ? '8' : '12'; ?>" id="assurantDirectLinkModalList">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="ibox ">
                        <div class="ibox-title"><h5>Lead Information</h5></div>
                    ...
                    <div class="pull-right"><button type="button" class="btn btn-white" onclick="window.location.hash = '#lead'">Cancel</button> <button type="submit" class="btn btn-success">Submit</button></div>
                </div>
            </div>
            ...
            if (form.parsley().isValid()) {
                ...
                $.when(saveLeadInfo(data)).then(function (response) {
                    ...
                    if (response.meta.success) {
                        ...
                        window.location.hash = '#lead/edit/' + data._id + '?popup=closed';
